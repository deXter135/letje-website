        ...
        <nav class="blauw" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="aanbod" class="activenav">Aanbod</a></li>
                ...
                <ul id="nav-mobile" class="side-nav">
                    <li><a href="http://www.letje.nl">Home</a></li>
                    <li><a href="aanbod" class="activenavsmall">Aanbod</a></li>
                    <li><a href="impressie">Impressie</a></li>
                    <li><a href="contact">Contact</a></li>
                    <li><a href="overons">Over ons</a></li>
                </ul>
            ...
            <div class="col s12 m4">
                <div class="card blue-grey darken-1">
                    <div class="card-image">
                        <img id="block" src="img/huisstijl.jpg">
                    </div>
                    <div class="card-content black-text">
                        <span class="card-title">Huisstijl</span>
                        <p>De visuele identiteit van uw bedrijf. Denk aan logo's, banners, visitekaartjes en briefpapier. Letje biedt dit allemaal in een mooi totaalpakket.</p>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card blue-grey darken-1">
                    <div class="card-image">
                        <img id="block" src="img/website.jpg">
                    </div>
                    <div class="card-content black-text">
                        <span class="card-title">Website</span>
                        <p>Online bereikbaarheid is erg belangrijk tegenwoordig. Letje maakt uw website zoals u dat wilt en zorgt dat deze goed vindbaar is.</p>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card blue-grey darken-1">
                    <div class="card-image">
                        <img id="block" src="img/promotie.jpg">
                    </div>
                    <div class="card-content black-text">
                        <span class="card-title">Promotiemateriaal</span>
                        <p>Letje maakt ook promotiemateriaal. Denk aan posters, animatiefilmpjes, <br>t-shirt design, advertenties en nog veel meer!</p>
                    </div>
                </div>
            </div>
        </div>
