        ...
        <nav class="blauw" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="contact" class="activenav">Contact</a></li>
                ...
                <ul id="nav-mobile" class="side-nav">
                    ...
                    <li><a href="aanbod">Aanbod</a></li>
                    <li><a href="impressie">Impressie</a></li>
                    <li><a href="contact" class="activenavsmall">Contact</a></li>
                    <li><a href="overons">Over ons</a></li>
                </ul>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col l6 s12">
                <h4 class="header black-text lijn">Contact</h4>
                <p>Wilt u met ons in contact komen? Vul dan het formulier in, of stuur ons een mailtje. Wij zullen zo snel mogelijk reageren.</p>
                <p class="black-text"><strong>E-mail:</strong> <a href="mailto:info@letje.nl">info@letje.nl</a></p>
                <p>
                    </br>
                </p>
                <p class="black-text"><strong>Kvk-nummer:</strong> 67052592</p>
                <p class="black-text"><strong>Btw-nummer:</strong> Op aanvraag i.v.m. identiteitsfraude</p>
                <p>
                    </br>
                </p>
                <p class="black-text"><strong>Bekijk ons ook op social media:</strong></p>
                <p>
                    <a href="https://www.facebook.com/letje.nl/?fref=ts">
                        <svg class="verbindbutton" style="width:50px;height:50px" viewBox="0 0 24 24">
                          <path fill="#00AEEF" d="M19,4V7H17A1,1 0 0,0 16,8V10H19V13H16V20H13V13H11V10H13V7.5C13,5.56 14.57,4 16.5,4M20,2H4A2,2 0 0,0 2,4V20A2,2 0 0,0 4,22H20A2,2 0 0,0 22,20V4C22,2.89 21.1,2 20,2Z" />
                        </svg>
                    </a>
...
?>
  ...
  <script>  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','https://www.google-analytics.com/analytics.js','ga'); ga('create', 'UA-85692575-1', 'auto'); ga('send', 'pageview');</script>
